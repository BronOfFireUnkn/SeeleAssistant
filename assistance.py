...
def start_Official():
    ...
    sleep(10.0)
    wait(Template(r"resources\forstart\Official\resources\forstart\Official\tpl1696321843906.png", record_pos=(-0.456, 0.234), resolution=(1920, 1080)), timeout=60, intervalfunc=update)
